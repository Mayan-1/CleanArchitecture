...
namespace CleanArchitecture.Application.UseCases.Professors.Create;

public sealed class CreateProfessorValidator : AbstractValidator<CreateProfessorRequest>
{
